...
{
@public
    IBOutlet id captureTime;
    IBOutlet id captureTimeHeader;
    IBOutlet id inputCardMenu;
    IBOutlet id outputCardMenu;
    IBOutlet id startButton;
    IBOutlet id videoFormatMenu;
    IBOutlet id window;
	
	BOOL					running;
	IDeckLink*				deckLink[MAX_DECKLINK];
...
public:
						VideoDelegate (MyController* controller);
